...
export const ContactInfo = () => {
    ...
    useEffect(() => {
        fetch(`https://trifecta-web-api.herokuapp.com/api/Administrator/GetUserContactsVerivicationList`, {
            headers: {
                'Accept': '*/*',
    ...
    const verifyChange = (requestId, userId) => {
        fetch(`https://trifecta-web-api.herokuapp.com/api/Administrator/AcceptUserContactVerification?requestId=${requestId}&userId=${userId}`, {
    ...
    const rejectChange = (requestId, userId) => {
        fetch(`https://trifecta-web-api.herokuapp.com/api/Administrator/RejectUserContactVerification?requestId=${requestId}&userId=${userId}`, {
            method: 'POST', // *GET, POST, PUT, DELETE, etc.
            mode: 'cors', // no-cors, *cors, same-origin
            cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
            credentials: 'same-origin', // include, *same-origin, omit
